...
***The possible responses to this question is Yes, No, N/A.***
...
***43% of the respondents have been harassed by their superiors or co-workers at thair job.***
...
***The mean is a better measure of the typical amount of time americans spend on email weekly because the data is skewed. The mean number of minutes spent on email per week is 417 mins***
...
***Possible responses are Keeping House (284), Other (89), Retired (574), School(76), Temp not working (57), Unemployed laid off (118), working full time (1321) and working part time (343).***
